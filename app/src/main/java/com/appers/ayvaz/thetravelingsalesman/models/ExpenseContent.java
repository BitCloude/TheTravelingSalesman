...
public class ExpenseContent {
    ...
    private static ContentValues getContentValues(Expense expense) {
        ...
        values.put(DbSchema.ExpenseTable.Cols.EXPENSE_DATE_FROM, expense.getDate_from());
        values.put(DbSchema.ExpenseTable.Cols.EXPENSE_DATE_TO, expense.getDate_to());
    ...
    public List<Expense> getExpenses() {
        ...
        String sortOrder = DbSchema.ExpenseTable.Cols.EXPENSE_ID;
